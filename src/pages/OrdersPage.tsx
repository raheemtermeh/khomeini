...
const RESERVATION_API_BASE_URL =
  "https://fz-backoffice.linooxel.com/api/venues/proxy/event-reservations/";
const EVENT_API_URL =
    ...
    <div className="space-y-12 p-4 sm:p-6 md:p-8">
      ...
      <div className="space-y-6">
        ...
        {loadingReservations || loading ? (
          ...
          <p className="text-center text-gray-500 dark:text-gray-400">
            هیچ سفارشی برای ایونت‌های شما ثبت نشده است.
          </p>
        ) : (
                ...
                >
                  <div className="space-y-1 md:space-y-0 md:space-x-4 flex-grow flex flex-wrap gap-x-6 gap-y-1">
                    ...
                    <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <span>
                        ثبت شده در: {formatDateTime(reservation.created_at)}
                      </span>
                    </div>
              ...
              return (
                  ...
                  className={`
                                        ...
                                        ${
                                          !isExpanded
                                            ...
                                            : "scale-[1.01] shadow-2xl ring-2 ring-opacity-70 ring-red-500/50"
                                        }
                ...
                >
                  ...
                  <div className="relative z-10 space-y-3 text-right">
                    ...
                    <div className="text-sm space-y-2">
                      ...
                      <div className="flex items-center flex-row-reverse justify-start text-gray-600 dark:text-gray-300">
                        ...
                        >
                          <path
                            ...
                            strokeWidth="2"
                            d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-4 0H5m4 0h6m-3 0V7m-4 4h10m-10 4h.01M16 12h.01"
                          ></path>
                        </svg>
                      ...
                      <div className="flex items-center flex-row-reverse justify-start text-gray-600 dark:text-gray-300">
                        ...
                        ({event.duration_minutes} دقیقه)
                      </div>

                      {/* ظرفیت - RTL Corrected */}
                      <div className="flex items-center flex-row-reverse justify-start text-gray-600 dark:text-gray-300">
                        <svg
                          className="w-4 h-4 mr-1 text-indigo-500 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth="2"
                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m4-10a4 4 0 11-8 0 4 4 0 018 0zM7 13H3v-2a3 3 0 015.356-1.857M16 12h2m-2 2h4m-4 2h2m-6-10h4M4 14h6m-6-6h6"
                          ></path>
                        </svg>
                        <span className="font-medium">ظرفیت:</span>
                        <span className="mr-1 font-semibold">
                          {event.min_capacity} تا {event.max_capacity} نفر
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  {isExpanded && (
                    ...
                    >
                      <h4 className="font-bold text-lg text-gray-900 dark:text-white border-b border-gray-300 dark:border-gray-600 pb-1">
                        اطلاعات تکمیلی شعبه ({event.branch_name})
                      </h4>
                      ...
                      <div className="text-sm space-y-3">
                        ...
                        <div className="flex items-center flex-row-reverse justify-start text-gray-700 dark:text-gray-300">
                          ...
                          <a
                            href={`tel:${event.branch_data.phone}`}
                            className="mr-1 font-mono text-red-600 dark:text-red-400 hover:text-red-500"
                          >
                            {event.branch_data.phone}
                          </a>
                        </div>
                        ...
                        <div className="flex items-center flex-row-reverse justify-start text-gray-700 dark:text-gray-300">
                          ...
                          <span className="mr-1 font-medium">
                            {event.branch_data.open_hours.mon_fri}
                          </span>
                        </div>
                      </div>
